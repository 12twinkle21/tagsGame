const gameNode = document.querySelector('.page');
const containerNode = document.querySelector('.fifteen');
const itemNodes = Array.from(containerNode.querySelectorAll('.item'));
const countItems = 16;

if (itemNodes.length !== countItems) {
   throw new Error(`Должно быть ровно ${countItems} item в HTML`)
}
...
window.addEventListener("DOMContentLoaded", startShuffle());